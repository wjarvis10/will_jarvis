    ...
    return (
        <div id="mainFrame">
            ...
            <div id="projects">
                ...
                <Project projectRowStyle={"projectRowReverse"} projectImage={"developmentImage.jpg"} imgAltTag={"Image of the sneaker website one a laptop."} imgStyleID={"calientesImage"} websiteLink={"https://boredbear123.github.io/development_2/"} buttonText={"VISIT WEBSITE"} projectTitle={"WEBSITE DEVELOPMENT"} description={"Devloped an interactive online store for Air Jordan Sneakers, where you can filter and sort the products, and even add sneakers to your cart."}></Project>
